...
#region movement/physics
	...
	//default is used in calcuations when setting speeds
	default_maxspd = maxspd
	default_acceleration = acceleration
	
	//base is the base standard that is passed onto the defaults after item effects apply
	base_maxspd = maxspd
...
cooldown
	...
	playersprites[0]=sp_modelTest00
	playersprites[7]=sp_modelTest01
	playersprites[6]=sp_modelTest02
	playersprites[5]=sp_modelTest03
	playersprites[4]=sp_modelTest04
	playersprites[3]=sp_modelTest05
	playersprites[2]=sp_modelTest06
	playersprites[1]=sp_modelTest07
